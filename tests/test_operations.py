...
class TestPower(BaseOperationTest):
    ...
    invalid_test_cases = {
        "negative_exponent": {
            ...
            "b": "-3",
            "error": ValidationError,
            "message": "Error: Cannot raise zero to the power of a negative number"
        },
    }
...
class TestRoot(BaseOperationTest):
    ...
    invalid_test_cases = {
        "negative_base": {
            ...
            "b": "2",
            "error": ValidationError,
            "message": "Error: Cannot take the root of a negative number"
        },
        "zero_root": {
            "a": "9",
            "b": "0",
            "error": ValidationError,
            "message": "Error: Zero root is undefined"
        },
    }
...
class TestModulus(BaseOperationTest):
    ...
    valid_test_cases = {
        "positive_numbers": {"a": "16", "b": "9", "expected": "7"},
        "negative_numbers": {"a": "-7", "b": "-2", "expected": "-1"},
        "mixed_signs": {"a": "-7", "b": "2", "expected": "-1"},
        "decimals": {"a": "16.4", "b": "6.5", "expected": "3.4"},
        "divide_zero": {"a": "0", "b": "5", "expected": "0"},
    }
    invalid_test_cases = {
        "divide_by_zero": {
            ...
            "b": "0",
            "error": ValidationError,
            "message": "Error: Cannot find remainder of a number divided by zero"
        }
    }
...
class TestIntegerDivision(BaseOperationTest):
    ...
    valid_test_cases = {
        "positive_numbers": {"a": "11", "b": "2", "expected": "5"},
        "negative_numbers": {"a": "-6", "b": "-4", "expected": "1"},
        "mixed_signs": {"a": "-14", "b": "3", "expected": "-4"},
...
class TestPercentage(BaseOperationTest):
    ...
    valid_test_cases = {
        "positive_numbers": {"a": "5", "b": "2", "expected": "250"},
        "negative_numbers": {"a": "-5", "b": "-8", "expected": "62.5"},
        "mixed_signs": {"a": "-10", "b": "25", "expected": "-40"},
        "decimals": {"a": "8.2", "b": "20.5", "expected": "40"},
        "divide_zero": {"a": "0", "b": "43", "expected": "0"},
    }
    invalid_test_cases = {
        "divide_by_zero": {
            "a": "4",
...
class TestAbsoluteDifference(BaseOperationTest):
    ...
    valid_test_cases = {
        "positive_numbers": {"a": "8", "b": "3", "expected": "5"},
        "negative_numbers": {"a": "-8", "b": "-4", "expected": "4"},
        "negative_first_operand": {"a": "-4", "b": "1", "expected": "5"},
        "negative_second_operand": {"a": "10", "b": "-17", "expected": "27"},
        "zero_result": {"a": "5", "b": "5", "expected": "0"},
        "decimals": {"a": "5.5", "b": "9.3", "expected": "3.8"},
        "large_numbers": {
            "a": "2e4",
            "b": "5.385e4",
            "expected": "33850"
